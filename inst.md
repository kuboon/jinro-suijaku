...
nav: |
  <ul>
    ...
    <li><a href='#variations'>バリエーションルール</a></li>
...
# バリエーションルール {#variations}
## 秘密占い
- 占いをする時に「占います」と宣言します。相手は10秒間目をつむります。
- 通常ルールと異なり、どのカードを占ったか、相手に知られません。また、占いカードを示す必要もありません。
- 占いカードを引いてない時も「占います」と宣言が可能です。この場合、実際に占いは出来ませんが、占ったフリをする事が出来ます。
- 目をつむった側は「どれを占った？何だった？」と聞いてみましょう！

## 3人ゲーム
- 1人2枚ずつ引き、それ以外は全く同じルールで3人でもプレイ可能です。

<aside><p>バリエーションルールは適宜追加しますので、時々見に来てくださいね！</p></aside>
